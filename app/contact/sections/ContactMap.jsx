...
export default function ContactMap() {
    ...
    <section className="py-12 sm:py-16 lg:py-20 2xl:py-24 bg-[#060812]">
      ...
      >
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-1.5  text-[#5b8def] text-lg font-semibold rounded-full mb-4">
            Our Location
          </span>
  ...
  <div className="w-full h-80 sm:h-96 md:h-[500px] relative">
    ...
    <iframe
      ...
      style={{
        border: 0,
        filter: "invert(90%) hue-rotate(180deg) brightness(85%) contrast(120%) saturate(0.8)",
      }}
      allowFullScreen=""
      loading="lazy"
    ...
    {/* Tint overlay to pull it into your dark blue palette */}
    <div
      className="absolute inset-0 pointer-events-none"
      style={{ background: "rgba(6, 8, 18, 0.18)", mixBlendMode: "multiply" }}
    />
    ...
    {/* Location Badge */}
    <div className="absolute top-6 right-6 rounded-xl px-4 py-2 shadow-lg z-10 border border-[#5b8def]/20 bg-[#060812]/90 backdrop-blur-sm">
