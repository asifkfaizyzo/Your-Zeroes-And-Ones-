  ...
  return (
    <section className="relative bg-gradient-to-br from-[#0f172a] via-[#1e3a5f] to-[#20427f] py-1 md:py-1 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 left-10 w-20 h-20 bg-blue-500/20 rounded-2xl blur-sm"
      />
      <motion.div
        animate={{ y: [0, 20, 0], rotate: [0, -5, 0] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute bottom-20 right-10 w-32 h-32 bg-purple-500/20 rounded-full blur-sm"
      />
      ...
      >
        <div className="text-center py-8  xl:pb-35">
          ...
          <motion.h1
            ...
            className="pt-10 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6"
          >
            Our{" "}
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-blue-100/80 max-w-3xl mx-auto mb-10"
          >
            Explore our collection of successful projects spanning web development, 
