              ...
              {[
                {
                  title: "Scalability & Flexibility",
                  description:
                    "Dynamically scale resources up or down based on demand with pay-as-you-go pricing that grows with your business.",
                  icon: (
                    <svg
                      className="w-8 h-8"
                      fill="none"
                ...
                },
                {
                  ...
                  description:
                    "Reduce capital expenditure with operational expense models and intelligent resource optimization strategies.",
                  icon: (
                    <svg
                      className="w-8 h-8"
                      fill="none"
                ...
                },
                {
                  title: "Security & Compliance",
                  description:
                    "Enterprise-grade security with industry compliance certifications and continuous monitoring across all environments.",
                  icon: (
                    <svg
                      className="w-8 h-8"
                      fill="none"
                ...
                },
                {
                  title: "Global Reach",
                  description:
                    "Deploy applications closer to your users with worldwide data center presence for optimal performance and low latency.",
                  icon: (
                    <svg
                      className="w-8 h-8"
                      fill="none"
