...
export default function QuoteTestimonialCard({ testimonial, index }) {
  ...
  return (
    ...
    >
      {/* Quote Icon */}
      <svg className="w-8 h-8 text-[#5b8def]/20 mb-3 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Message */}
      <p className="text-white/80 text-sm leading-relaxed line-clamp-4 mb-4 flex-1">"{testimonial.message}"</p>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-1.5">
            ...
            {testimonial.verified && (
              <svg className="w-3.5 h-3.5 text-[#5b8def] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
