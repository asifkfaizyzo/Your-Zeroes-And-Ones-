...
export default function DigitalMarketing() {
  ...
  const ctaLinks = [
    { text: "Get Marketing Audit", href: "/contact", variant: "primary" },
    { text: "View Case Studies", href: "/portfolio", variant: "secondary" },
  ];
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center rounded-2xl p-6 border border-[#5b8def]/20 bg-[#5b8def]/5 backdrop-blur-sm"
              >
                <div className="text-3xl font-bold text-[#5b8def] mb-2">
                  {stat.value}
                </div>
