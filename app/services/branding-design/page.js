        ...
        <section className="bg-gradient-to-br from-[#f0f4ff] to-[#e8efff] py-20">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Transform your vision into compelling visual identities that resonate with your audience and drive business growth.
            </p>
          ...
          >
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive branding and design solutions tailored to make your business stand out.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-[#20427f] to-[#2c5aa0]">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Let's create a memorable brand identity that sets you apart from the competition.
            </p>
