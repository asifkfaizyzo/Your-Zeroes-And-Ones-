// app/services/branding-design/ai-video-production/page.js
...
export const metadata = {
  ...
  description:
    "Cutting-edge AI-powered video creation and enhancement services for efficient and innovative content production",
};
...
export default function AIVideoProduction() {
  const processes = [
    {
      name: "Prompting",
      icon: <PromptingIcon />,
      description: "Crafting precise AI instructions and creative direction",
    },
    {
      name: "Generating",
      icon: <GeneratingIcon />,
      description: "AI-powered video creation from text and parameters",
    },
    {
      name: "Editing",
      icon: <EditingIcon />,
      description: "Refining and perfecting AI-generated content",
    },
    {
      name: "Augmenting",
      icon: <AugmentingIcon />,
      description: "Enhancing videos with effects and additional elements",
    },
    {
      name: "Refining",
      icon: <RefiningIcon />,
      description: "Iterative improvement and quality optimization",
    },
    {
      name: "Finalizing",
      icon: <FinalizingIcon />,
    ...
    },
    {
      name: "Publishing",
      icon: <PublishingIcon />,
      description: "Format optimization and platform deployment",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#060010] pt-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/50 mb-8 leading-relaxed">
                Cutting-edge AI-powered video creation and enhancement
                services that revolutionize content production with
                unprecedented speed, efficiency, and creative possibilities.
              </p>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/50 max-w-3xl mx-auto">
              Transform your video production workflow with artificial
              intelligence
            </p>
          </div>
            ...
            {benefits.map((benefit, index) => (
              <div
                ...
                className="rounded-xl p-6 text-center border border-[#5b8def]/20 bg-[#5b8def]/5 backdrop-blur-sm
                           ...
                           hover:shadow-lg hover:shadow-[#5b8def]/10 transition-all duration-300"
              >
                <div className="text-3xl font-bold text-[#5b8def] mb-4">
                  {benefit.value}
                </div>
      ...
      {/* Process Section */}
      <section id="process" className="py-20 bg-[#060010]">
        <div
          className="max-w-[1800px] mx-auto"
          style={{
            paddingLeft: "clamp(2rem, 8vw, 12rem)",
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/50 max-w-3xl mx-auto">
              A streamlined workflow that combines human creativity with
      ...
      <section className="py-20 bg-[#060812]">
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/50 max-w-3xl mx-auto">
              Comprehensive AI video solutions for diverse industries and use
              cases
            </p>
          </div>
      ...
      <ServiceProjects
        ...
        subCategoryName="AI Video Production"
      />
      ...
      <section className="py-20 bg-gradient-to-br from-[#0a1628] via-[#0f1d32] to-[#0a1628] relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-blue-200/70 mb-8 max-w-2xl mx-auto">
            Experience the future of video creation with our AI-powered
            production services.
          </p>
