  ...
  const services = [
    {
      ...
      description:
        "Strategic brand development and positioning to create a strong market presence.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Memorable and impactful logo designs that represent your brand identity.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Bringing ideas to life with stunning 2D and 3D visual representations.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Professional video content creation for marketing and storytelling.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "High-quality audio content including podcasts, voiceovers, and sound design.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Cutting-edge AI-powered video creation and enhancement services.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
