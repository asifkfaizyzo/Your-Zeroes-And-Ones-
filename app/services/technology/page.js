// app/services/technology/page.js
import Link from "next/link";

export const metadata = {
  title: "Technology Services - YourZerosAndOnes",
  description:
    "Cutting-edge technology solutions including AI, web development, cloud services and more",
};
...
export default function Technology() {
  const services = [
    ...
    },
    {
      ...
      path: "/services/technology/devops-consulting",
      description:
    ...
    },
    {
      ...
      description:
        "Complete e-commerce platforms and online store solutions for businesses of all sizes.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="#5b8def" strokeWidth={1.5} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round"
    ...
    },
    {
      ...
      description:
        "Cloud infrastructure, migration, and management services for scalable solutions.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="#5b8def" strokeWidth={1.5} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round"
    ...
    },
    {
      ...
      description:
        "Data solutions and analytics platforms to drive business insights and decisions.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="#5b8def" strokeWidth={1.5} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round"
    ...
    },
    {
      ...
      description:
        "Protect your digital assets with comprehensive security solutions and monitoring.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="#5b8def" strokeWidth={1.5} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round"
  ...
  const ctaLinks = [
    ...
    { text: "View Tech Portfolio", href: "/portfolio", variant: "secondary" },
  ];
      ...
      <section className="bg-gradient-to-br from-[#060010] via-[#0a1628] to-[#060010] py-20">
        ...
        >
          ...
          <p className="text-xl text-white/50 mb-8 max-w-3xl mx-auto leading-relaxed">
            Cutting-edge technology solutions that power your business growth
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/50 max-w-3xl mx-auto">
              Comprehensive technology services designed to build, scale, and
