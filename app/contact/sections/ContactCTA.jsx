  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 2xl:py-24 bg-gradient-to-br from-[#0a1628] via-[#0f1d32] to-[#0a1628] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-64 h-64 bg-[#203E7F] rounded-full filter blur-3xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-[#203E7F] rounded-full filter blur-3xl animate-pulse" />
      </div>
          ...
          {ctaButtons.map((button, index) => (
            <a
              ...
              className={`inline-flex items-center justify-center px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 hover:scale-105 group ${
                button.primary
                  ? "bg-white text-[#0f1d32] hover:bg-blue-50 shadow-lg hover:shadow-[#5b8def]/20"
