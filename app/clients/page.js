...
export default function ClientsPage() {
  ...
  return (
    <>
      <main className="min-h-screen bg-white relative z-0 pt-10">
        {/* Hero Section */}
          ...
          <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              ...
              <nav className="flex justify-center mb-8" aria-label="Breadcrumb">
                <ol className="flex items-center space-x-3 text-sm sm:text-base">
                  <li>
                    <Link
                      href="/"
                      className="text-blue-200/80 hover:text-white transition-colors duration-300 flex items-center gap-2"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="currentColor"
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-blue-100/80 max-w-3xl mx-auto leading-relaxed">
                Partnering with industry leaders across diverse sectors to
                deliver exceptional digital solutions that drive success.
              </p>
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="relative">
              <svg
                className="w-12 h-12 text-[#203E7F]/20 mx-auto mb-6"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <blockquote className="text-2xl sm:text-3xl lg:text-4xl font-medium text-gray-800 leading-relaxed">
                "Working with exceptional partners has been the cornerstone of
                our success.
                <span className="text-[#203E7F]">
                  {" "}
